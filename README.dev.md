# `illustrannotate` developer documentation
...
# install illustrannotate as an editable package
...
The second is to use `tox`, which can be installed separately (e.g. with `pip install tox`), i.e. not necessarily inside the virtual environment you use for installing `illustrannotate`, but then builds the necessary virtual environments itself by simply running:
...
cd $(mktemp -d illustrannotate.XXXXXX)
git clone git@github.com:DaniBodor/illustrannotate .
...
Visit
[https://test.pypi.org/project/illustrannotate](https://test.pypi.org/project/illustrannotate)
and verify that your package was uploaded successfully. Keep the terminal open, we'll need it later.

In a new terminal, without an activated virtual environment or an env directory:

```shell
cd $(mktemp -d illustrannotate-test.XXXXXX)
...
--extra-index-url https://pypi.org/simple illustrannotate
```
...
Don't forget to also make a [release on GitHub](https://github.com/DaniBodor/illustrannotate/releases/new).